                ...
                <footer className="redes-borde">
                    <div className="redes-fondo redes-margin">
                        <div className="m-0 text-right text-white">
                            <div>
                                <a href="https://www.facebook.com/gamer.vip.arg/" target="_blank"> <i className="fab fa-facebook fa-4x" /> </a>

                                <a href="https://www.instagram.com/gamer.vip.arg/" target="_blank"> <i className="fab fa-instagram fa-4x" /> </a>

                                <a href="https://www.twitch.tv/gamerviparg" target="_blank"> <i className="fab fa-twitch fa-4x" /> </a>

                                <a href="mailto:info@demo.com" target="_blank"> <i className="fas fa-envelope-open-text fa-4x" /> </a>
