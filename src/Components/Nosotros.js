...
export default class Nosotros extends Component {
  render() {
    return (
      <div className="nosotros-fondo nosotros-borde">
        <div className="m-auto">
          ...
          <div className="container">
            ...
            <h5 className="nosotros-h5-formato">Gracias a tú confianza vamos a ser la Tienda Gamer número 1 de Argentina.</h5><br />
            <h3 className="nosotros-h3-formato">Mapa</h3>
            <p className="nosotros-p-formato">Avenida Corrientes 6237, CABA.</p>
            ...
            <h3 className="nosotros-h3-formato">Redes Sociales</h3>
